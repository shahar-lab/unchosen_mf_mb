...
fit_200 <- readRDS(paste0(path$data, '/modelfit_recovery_full_200', '.rds'))
fit_100 <- readRDS(paste0(path$data, '/modelfit_recovery_full_100', '.rds'))
fit_50 <- readRDS(paste0(path$data, '/modelfit_recovery_full_50', '.rds'))
...
ggsave(filename = path_save, plot = p, width = 400 / 72, height = 300 / 72)
