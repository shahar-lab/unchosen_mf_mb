...
#pre-allocation
  ...
  alpha_mb_unch = inv_logit_scaled(parameters['alpha_mb_unch'])
...
for (block in 1:Nblocks){
  ...
  for (trial in 1:Ntrials_perblock){
    ...
    Qmb[unique_unch_object] = Qmb[unique_unch_object] +alpha_mb_unch*((1-unique_reward)-Qmb[unique_unch_object])
  }
}     
  return (df)
}