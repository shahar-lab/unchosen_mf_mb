...
# model_parameters$artificial_population_location    =c(0.23,0.23,-0.1,0,0.13,0.31,0.31,0.06)
# model_parameters$artificial_population_scale       =c(0.33,0.33,0.16,0.16,0.07,0.12,0.12,0.02)
model_parameters$artificial_population_location    =c(0.52,0.59,-0.11,-0.09,-1.06,0.26,0.50,0.44)
model_parameters$artificial_population_scale       =c(0.51,0.62,0.11,0.24,0.79,0.15,0.23,0.08)
