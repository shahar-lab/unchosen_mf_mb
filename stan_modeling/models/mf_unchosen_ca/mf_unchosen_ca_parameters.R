...
model_parameters$names                             =c('c_mf',"c_mb",'pr','f','f_p','c_mf_unch')
model_parameters$transformation                    =c('none','none','none','logit','logit','none')
model_parameters$artificial_population_location    =c(0.4,0.4,0.1,qlogis(0.8),qlogis(0.95),-0.2)
model_parameters$artificial_population_scale       =c(0.5,0.5,0.1,0.3,0.3,0.5)
