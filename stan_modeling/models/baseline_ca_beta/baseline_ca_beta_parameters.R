...
model_parameters$names                             =c('c_mf',"c_mb",'pr','f_mf','f_mb','f_p')
model_parameters$transformation                    =c('none','none','none','beta','beta','beta')
model_parameters$artificial_population_location    =c(0,0,0,0.5,0.5,0.5)
model_parameters$artificial_population_scale       =c(4,4,4,0.2,0.2,0.2)
# model_parameters$artificial_population_location    =c(0.47,0.47,0.13,0.31,0.31,0.06)
# model_parameters$artificial_population_scale       =c(0.33,0.33,0.09,0.18,0.18,0.04)
