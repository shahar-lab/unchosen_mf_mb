...
model_parameters$transformation                    =c('none','none','none','logit','logit','logit','none','none')
model_parameters$artificial_population_location    =c(0,0,0,qlogis(0.5),qlogis(0.5),qlogis(0.5),0,0)
model_parameters$artificial_population_scale       =c(4,4,4,1,1,1,4,4)
