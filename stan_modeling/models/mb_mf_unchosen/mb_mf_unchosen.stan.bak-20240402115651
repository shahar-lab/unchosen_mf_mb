...
transformed parameters {
  ...
  for (subject in 1 : Nsubjects) {
    ...
    for (trial in 1 : Ntrials_per_subject[subject]) {
      ...
      PE_mf_unch = (1-common_reward[subject, trial]) + (1-unique_reward[subject, trial])
      ...
      Qmf[unch_person[subject, trial]] = Qmf[unch_person[subject, trial]]
                                       ...
                                       + alpha_mf_unch[subject] * PE_mf_unch;
      ...
      PE_mb_unch =  (1-unique_reward[subject, trial]) - Qmb[unique_unch_object[subject, trial]];
