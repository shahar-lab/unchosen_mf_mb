...
model_parameters$artificial_population_location    =c(qlogis(0.5),qlogis(0.5),qlogis(0.5),qlogis(0.5),qlogis(0.5),3)
model_parameters$artificial_population_scale       =c(1,1,1,1,1,1)
